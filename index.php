...
echo " <h1 class='songheader'>Recently Added</h1>";
$i=0;
...
echo "
        <div class='box'> 
        <form action='vote.php?id=$id&genre=$gen&source=home' method='post'>
...
<iframe id='html5Vid' class='youtube-player' type='text/html' src='http://www.youtube.com/embed/$link' frameborder='0' allowfullscreen></iframe>
      ...
      <blockquote>
        Artist: $artist<br>
        Album: $album <br>
<form action='flag.php?id=$id&genre=$gen&source=home' method='post'>
